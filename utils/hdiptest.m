...
function        [dip, p_value, xlow,xup]=hdiptest(xpdf,nboot)

%  function     [dip,p_value,xlow,xup]=hdiptest(xpdf,[nboot=1000])
%
...
[dip,xlow,xup, ifault, gcm, lcm, mn, mj]=hdip(xpdf);
N=length(xpdf);
